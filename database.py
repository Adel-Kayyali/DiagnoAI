...
def insert_data (Mean_Radius,Mean_Perimeter,Mean_Area,Mean_Concavity,Mean_Concavity_Points,Worst_Radius,Worst_Perimeter
                ,Worst_Area,Worst_Concavity,Worst_Concavity_Points):
    """Returns the report on a succesful creation, otherwise raises an error"""
    return db.put({"key":Mean_Radius, "Mean_Perimeter":Mean_Perimeter, "Mean_Area":Mean_Area, "Mean_Concavity":Mean_Concavity,
